...
export class VaultGithubAuth extends pulumi.ComponentResource {
  ...
  constructor(
    ...
    this.githubAuth = new vault.github.AuthBackend(
      `${name}-github-auth`,
      {
    ...
    this.readonlyTeam = new VaultGithubTeam(
      `${name}-readonly-team`,
      {
        team: "contributor",
        name: "readonly-team",
        policyContent: readFileSync(
          `${__dirname}/policies/github-readonly.hcl`,
        ).toString(),
    ...
    this.adminTeam = new VaultGithubTeam(
      `${name}-admin-team`,
      {
        team: "maintainers",
        name: "admin-team",
        policyContent: readFileSync(
          `${__dirname}/policies/github-admin.hcl`,
        ).toString(),
        vaultProvider: this.vaultProvider,
      },
      { parent: this },
    ...
    this.dataScienceTeam = new VaultGithubTeam(
      `${name}-ds-team`,
      {
        team: "data-science",
        name: "data-science-team",
        policyContent: readFileSync(
          `${__dirname}/policies/github-data-science.hcl`,
        ).toString(),
        vaultProvider: this.vaultProvider,
      },
      { parent: this },
    ...
    this.eloTeam = new VaultGithubTeam(
      `${name}-elo-team`,
      {
        team: "elo",
        name: "elo-team",
        policyContent: readFileSync(
          `${__dirname}/policies/github-elo.hcl`,
        ).toString(),
        vaultProvider: this.vaultProvider,
      },
      { parent: this },
