...
export class Monitoring extends pulumi.ComponentResource {
  ...
  constructor(
    name: string,
    { postgres, exposeInfluxUi, ingressNetworkId, providers }: MonitoringArgs,
    ...
    this.telegraf_replicated = new Telegraf(
      "replicated-telegraf",
      {
        additionalNetworkIds: [postgres.networkId],
