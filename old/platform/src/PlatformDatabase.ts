...
export class PlatformDatabase extends pulumi.ComponentResource {
  ...
  constructor(
    ...
    this.mledbSchema = new postgresql.Schema(
      `${name}-mledb-schema`,
      {
    ...
    this.sprocketSchema = new postgresql.Schema(
      `${name}-sprocket-schema`,
      {
        database: this.database.name,
        name: "sprocket",
        owner: this.credentials.username,
    ...
    this.historySchema = new postgresql.Schema(
      `${name}-history-schema`,
      {
        database: this.database.name,
        name: "history",
    ...
    this.dataScienceSchema = new postgresql.Schema(
      `${name}-data-science-schema`,
      {
        database: this.database.name,
        name: "data_science",
    ...
    this.mledbBridgeSchema = new postgresql.Schema(
      `${name}-mledb-bridge-schema`,
      {
        database: this.database.name,
        name: "mledb_bridge",
        owner: this.credentials.username,
    ...
    this.grants.dataScience.mledb.usage = new postgresql.Grant(
      `${name}-data-science-mledb-grant-usage`,
      {
        database: this.database.name,
        objectType: "schema",
    ...
    this.grants.dataScience.mledb.select = new postgresql.Grant(
      `${name}-data-science-mledb-grant-tables`,
      {
        database: this.database.name,
        objectType: "table",
        schema: this.mledbSchema.name,
    ...
    this.grants.dataScience.sprocket.usage = new postgresql.Grant(
      `${name}-data-science-sprocket-grant-usage`,
      {
        database: this.database.name,
        objectType: "schema",
    ...
    this.grants.dataScience.sprocket.select = new postgresql.Grant(
      `${name}-data-science-sprocket-grant`,
      {
        database: this.database.name,
        objectType: "table",
        schema: this.sprocketSchema.name,
    ...
    this.grants.dataScience.history.usage = new postgresql.Grant(
      `${name}-data-science-history-grant-usage`,
      {
        database: this.database.name,
        objectType: "schema",
    ...
    this.grants.dataScience.history.select = new postgresql.Grant(
      `${name}-data-science-history-grant`,
      {
        database: this.database.name,
        objectType: "table",
        schema: this.historySchema.name,
    ...
    this.grants.dataScience.mledbBridge.usage = new postgresql.Grant(
      `${name}-data-science-mledb-bridge-grant-usage`,
      {
        database: this.database.name,
        objectType: "schema",
    ...
    this.grants.dataScience.mledbBridge.select = new postgresql.Grant(
      `${name}-data-science-mledb-bridge-grant`,
      {
        database: this.database.name,
        objectType: "table",
        schema: this.mledbBridgeSchema.name,
    ...
    this.vault = new PostgresVaultProvider(
      `${name}-vault`,
      {
