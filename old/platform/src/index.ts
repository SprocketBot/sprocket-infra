...
const infrastructureVaultProvider = new vault.Provider(
  "InfrastructureVaultProvider",
  {
    address: LayerOne.stack.requireOutput(LayerOneExports.VaultAddress),
    token: LayerTwo.stack.requireOutput(
      LayerTwoExports.InfrastructureVaultToken,
    ),
  },
);
...
const postgresProvider = new SprocketPostgresProvider({
  ...
  postgresHostname: LayerTwo.stack.requireOutput(
    LayerTwoExports.PostgresUrl,
  ) as pulumi.Output<string>,
});

const minioProvider = new SprocketMinioProvider({
  vaultProvider: infrastructureVaultProvider,
  minioHostname: LayerTwo.stack.requireOutput(
    LayerTwoExports.MinioUrl,
  ) as pulumi.Output<string>,
});

const postgresNetworkId = LayerTwo.stack.requireOutput(
  LayerTwoExports.PostgresNetworkId,
) as pulumi.Output<string>;
const n8nNetworkId = LayerTwo.stack.requireOutput(
  LayerTwoExports.N8nNetwork,
) as pulumi.Output<string>;
...
export const platform = new Platform(pulumi.getStack(), {
  ...
  n8nNetworkId,
  postgresHostname: LayerTwo.stack.requireOutput(
    LayerTwoExports.PostgresHostname,
  ) as pulumi.Output<string>,
  ...
  ingressNetworkId: LayerOne.stack.requireOutput(
    LayerOneExports.IngressNetwork,
  ) as pulumi.Output<string>,
  monitoringNetworkId: LayerTwo.stack.requireOutput(
    LayerTwoExports.MonitoringNetworkId,
  ) as pulumi.Output<string>,
});
