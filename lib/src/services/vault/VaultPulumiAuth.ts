...
path "sys/mounts" { capabilities = [ "read" ] }
    ...
    const pulumiApproleId = new vault.approle.AuthBackendRole(
      "pulumi-approle",
      {
      ...
      {
        parent: this,
        provider: args.rootProvider,
        dependsOn: [approleBackend],
      },
    );

    const pulumiApproleSecret = new vault.approle.AuthBackendRoleSecretId(
      "pulumi-approle-secret",
      {
