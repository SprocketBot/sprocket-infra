 ...
 * ## Example Usage
 */
export declare class TerraformCloud extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TerraformCloudState, opts?: pulumi.CustomResourceOptions): TerraformCloud;
    /**
     * Returns true if the given object is an instance of TerraformCloud.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is TerraformCloud;
