 ...
 * ```
 */
export declare class Circleci extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CircleciState, opts?: pulumi.CustomResourceOptions): Circleci;
    /**
     * Returns true if the given object is an instance of Circleci.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is Circleci;
    /**
