 ...
 * ```
 */
export declare class Flyio extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FlyioState, opts?: pulumi.CustomResourceOptions): Flyio;
    /**
     * Returns true if the given object is an instance of Flyio.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is Flyio;
    /**
     * The app ID
     */
     ...
     */
    readonly deleteBehavior: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly restartMachines: pulumi.Output<boolean>;
    /**
