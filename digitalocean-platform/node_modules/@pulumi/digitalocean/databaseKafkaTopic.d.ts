 ...
 * ```
 */
export declare class DatabaseKafkaTopic extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DatabaseKafkaTopicState, opts?: pulumi.CustomResourceOptions): DatabaseKafkaTopic;
    /**
     * Returns true if the given object is an instance of DatabaseKafkaTopic.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DatabaseKafkaTopic;
    /**
     ...
     */
    readonly configs: pulumi.Output<outputs.DatabaseKafkaTopicConfig[]>;
    /**
