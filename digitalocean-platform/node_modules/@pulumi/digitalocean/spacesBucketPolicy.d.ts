...
export declare class SpacesBucketPolicy extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SpacesBucketPolicyState, opts?: pulumi.CustomResourceOptions): SpacesBucketPolicy;
    /**
     * Returns true if the given object is an instance of SpacesBucketPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SpacesBucketPolicy;
    /**
