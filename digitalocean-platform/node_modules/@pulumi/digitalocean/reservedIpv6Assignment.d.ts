 ...
 * ```
 */
export declare class ReservedIpv6Assignment extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ReservedIpv6AssignmentState, opts?: pulumi.CustomResourceOptions): ReservedIpv6Assignment;
    /**
     * Returns true if the given object is an instance of ReservedIpv6Assignment.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ReservedIpv6Assignment;
    /**
