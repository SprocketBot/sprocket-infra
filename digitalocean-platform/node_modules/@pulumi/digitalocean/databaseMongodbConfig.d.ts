 ...
 * ```
 */
export declare class DatabaseMongodbConfig extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DatabaseMongodbConfigState, opts?: pulumi.CustomResourceOptions): DatabaseMongodbConfig;
    /**
     * Returns true if the given object is an instance of DatabaseMongodbConfig.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DatabaseMongodbConfig;
    /**
     ...
     */
    readonly defaultReadConcern: pulumi.Output<string>;
    /**
     * Describes the level of acknowledgment requested from MongoDB for write operations clusters. This field can set to either `majority` or a number`0...n` which will describe the number of nodes that must acknowledge the write operation before it is fully accepted. Setting to `0` will request no acknowledgement of the write operation. Learn more [here](https://www.mongodb.com/docs/manual/reference/write-concern/).
     */
    readonly defaultWriteConcern: pulumi.Output<string>;
    /**
     ...
     */
    readonly slowOpThresholdMs: pulumi.Output<number>;
    /**
     ...
     */
    readonly transactionLifetimeLimitSeconds: pulumi.Output<number>;
    /**
     ...
     */
    readonly verbosity: pulumi.Output<number>;
    /**
