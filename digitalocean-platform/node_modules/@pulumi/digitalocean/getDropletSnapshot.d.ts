 ...
 * ```
 */
export declare function getDropletSnapshotOutput(args?: GetDropletSnapshotOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDropletSnapshotResult>;
/**
 * A collection of arguments for invoking getDropletSnapshot.
 */
