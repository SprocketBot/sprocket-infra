 ...
 * ```
 */
export declare class DropletAutoscale extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DropletAutoscaleState, opts?: pulumi.CustomResourceOptions): DropletAutoscale;
    /**
     * Returns true if the given object is an instance of DropletAutoscale.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DropletAutoscale;
    /**
     * The configuration parameters for Droplet Autoscale pool, the supported arguments are
     * documented below.
     */
    readonly config: pulumi.Output<outputs.DropletAutoscaleConfig>;
    /**
     ...
     */
    readonly currentUtilizations: pulumi.Output<outputs.DropletAutoscaleCurrentUtilization[]>;
    /**
     * The droplet template parameters for Droplet Autoscale pool, the supported arguments
     * are documented below.
     */
    readonly dropletTemplate: pulumi.Output<outputs.DropletAutoscaleDropletTemplate>;
    /**
