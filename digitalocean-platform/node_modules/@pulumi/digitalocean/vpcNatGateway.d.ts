 ...
 * ```
 */
export declare class VpcNatGateway extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VpcNatGatewayState, opts?: pulumi.CustomResourceOptions): VpcNatGateway;
    /**
     * Returns true if the given object is an instance of VpcNatGateway.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is VpcNatGateway;
    /**
     ...
     */
    readonly egresses: pulumi.Output<outputs.VpcNatGatewayEgress[]>;
    /**
     * The egress timeout value for ICMP connections of the VPC NAT Gateway.
     */
    readonly icmpTimeoutSeconds: pulumi.Output<number>;
    /**
     ...
     */
    readonly tcpTimeoutSeconds: pulumi.Output<number>;
    /**
     ...
     */
    readonly udpTimeoutSeconds: pulumi.Output<number>;
    /**
     ...
     * documented below.
     */
    readonly vpcs: pulumi.Output<outputs.VpcNatGatewayVpc[]>;
    /**
